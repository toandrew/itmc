...
public class CastMediaController extends MediaController {
    ...
    private boolean mIsPlayToCast = false;
...
//                    ITApp.getNetcastManager().seekTo((int) (mDuration * bar.getProgress()) / 1000 / 1000);
    ...
    public CastMediaController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRoot = this;
        mFromXml = true;
...
//            mFileName.setText(mTitle);
    ...
    private long setProgress() {
        ...
        long position = (mIsPlayToCast && mCastCurrentPosition > 0) ? mCastCurrentPosition : mPlayer.getCurrentPosition();
        long duration = (mIsPlayToCast && mCastDuration> 0) ? mCastDuration : mPlayer.getDuration();
